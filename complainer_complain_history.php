...
<head>
    ...
    $query="select c_id,type_crime,d_o_c,images,location from complaint where a_no='$a_no' order by c_id desc";
...
<?php
    ...
    <tbody style="background-color: white; color: black;">
      <tr>
        ...
        <td><?php 
        $c_id=$_SESSION['cid'];
        $img = mysqli_query($conn, "SELECT images FROM complaint");
      
		echo "<img src='images/".$rows['images']."', height=300px width=500px >" ;   
